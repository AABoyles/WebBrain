...
We have a bunch. But don't all those skills take up a bunch of context? Well, they normally would, but there's a cool trick we do. We de-couple skill descriptors from skill implementations. The descriptors go into context, and the implementations get called when needed. Knowing you know how to do something is a lot cheaper than knowing how to do it!

### Memory

One specific skill to call out: Here's the good part: as it learns about you, it stores that knowledge in IndexedDB. Right there in your browser.
